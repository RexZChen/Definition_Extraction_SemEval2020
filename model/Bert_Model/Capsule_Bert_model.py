"""
The implementation of Bert + Capsule.
1. Freezed pretrained-Bert + Capsule
2. Fine-tunned pretrained-Bert + Capsule
...
class BertCapsuleNet(nn.Module):

    def __init__(self, freeze_bert=False, num_classes=2, dropout_p=0.2):
        super(BertCapsuleNet, self).__init__()
    ...
    def forward(self, inputs):
        ...
        cap_out = self.cap_layer(encoded_layer)
